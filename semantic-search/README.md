...
- [SentenceTransformer: A Model For Computing Sentence Embedding](https://medium.com/data-science/sentencetransformer-a-model-for-computing-sentence-embedding-e8d31d9e6a8f)

## Repo
- https://github.com/boun-tabi-LMG/turkish-lm-tuner?tab=readme-ov-file


## Dataset 
- https://huggingface.co/datasets/boun-tabi/nli_tr
- https://hackmd.io/@data-tdd/r1zSlq5r5
- https://github.com/verimsu/STSb-TR/tree/main
