# 📚 29-Day LLM Paper Challenge - Complete Collection


## 📋 Week 1: Foundation & Basics (Gün 1-7)

### **Gün 1: Large Language Models: A Survey**
- **arXiv ID:** `2402.06196`
- **Link:** https://arxiv.org/abs/2402.06196
- **Kategori:** Survey, Foundation, Comprehensive Overview
- **Neden ilk:** Genel bakış, terminoloji, GPT/LLaMA/PaLM families
- **Abstract çekilecek:** ✅

---

### **Gün 2: Instruction Tuning for Large Language Models: A Survey**
- **arXiv ID:** `2308.10792`
...
### **Gün 3: LIMA: Less Is More for Alignment**
- **arXiv ID:** `2305.11206`
...
### **Gün 4: How Abilities in LLMs are Affected by SFT Data Composition**
- **arXiv ID:** `2310.05492`
- **Link:** https://arxiv.org/abs/2310.05492
- **Kategori:** SFT Strategy, Multi-task Learning, Data Composition
- **Neden:** Senin alanına direkt - math/code/general abilities interplay
- **Abstract çekilecek:** ✅

---

### **Gün 5: A Closer Look at the Limitations of Instruction Tuning**
- **arXiv ID:** `2402.05119`
- **Link:** https://arxiv.org/abs/2402.05119
- **Kategori:** Critical Analysis, Limitations, SFT Critique
- **Neden:** Critical thinking - IT'nin sınırlarını anlamak
- **Abstract çekilecek:** ✅

---

### **Gün 6: The False Promise of Imitating Proprietary LLMs**
- **arXiv ID:** `2305.15717`
- **Link:** https://arxiv.org/abs/2305.15717
- **Kategori:** Knowledge Distillation, Imitation Learning Critique
- **Neden:** Proprietary model'leri imitate etmenin pitfalls'ları
- **Abstract çekilecek:** ✅

---

### **Gün 7: A Survey on Evaluation of Large Language Models**
- **arXiv ID:** `2307.03109`
...
## 📋 Week 2: Advanced Fine-tuning & Data (Gün 8-14)

### **Gün 8: Instruction Pre-Training: Language Models are Supervised Multitask Learners**
- **arXiv ID:** `2406.14491`
- **Link:** https://arxiv.org/abs/2406.14491
- **Kategori:** Pre-training Innovation, Instruction Pre-training
- **Neden:** Yeni yaklaşım - pretraining phase'de instruction tuning
- **Abstract çekilecek:** ✅

---

### **Gün 9: Instruction-tuned Language Models are Better Knowledge Learners**
- **arXiv ID:** `2402.12847`
...
### **Gün 10: Scaling Laws Revisited: Modeling the Role of Data Quality**
- **arXiv ID:** `2510.03313`
...
### **Gün 11: Strategic Data Ordering: Curriculum Learning**
- **arXiv ID:** `2405.07490`
- **Link:** https://arxiv.org/abs/2405.07490
- **Kategori:** Curriculum Learning, Data Ordering
- **Neden:** Senin curriculum çalışmalarına direkt - data ordering strategies
- **Abstract çekilecek:** ✅

---

### **Gün 12: How Learning Rate Decay Wastes Your Best Data in Curriculum-Based LLM Pretraining**
- **arXiv ID:** `2511.18903`
- **Link:** https://arxiv.org/abs/2511.18903
- **Kategori:** Curriculum Learning, LR Scheduling, Training Dynamics
- **Neden:** Çok güncel (Nov 2025), LR decay + curriculum interaction
- **Abstract çekilecek:** ✅

---

### **Gün 13: Diversity-Oriented Data Augmentation with Large Language Models**
- **arXiv ID:** `2502.11671`
...
### **Gün 14: Evaluating the Diversity and Quality of LLM Generated Content**
- **arXiv ID:** `2504.12522`
...
## 📋 Week 3: Knowledge & Memory (Gün 15-21)

### **Gün 15: How Do LLMs Acquire New Knowledge? (Knowledge Circuits)**
- **arXiv ID:** `2502.11196`
...
### **Gün 16: Memorization and Knowledge Injection in Gated LLMs**
- **arXiv ID:** `2504.21239`
...
### **Gün 17: Investigating Continual Pretraining in Large Language Models**
- **arXiv ID:** `2402.17400`
...
### **Gün 18: Emergent Abilities in Large Language Models: A Survey**
- **arXiv ID:** `2503.05788`
...
### **Gün 19: Context Engineering 2.0: The Context of Context Engineering**
- **arXiv ID:** `2510.26493`
...
### **Gün 20: Efficient Large Language Models: A Survey**
- **arXiv ID:** `2312.03863`
...
### **Gün 21: Training and Serving System of Foundation Models: A Comprehensive Survey**
- **arXiv ID:** `2401.02643`
...
## 📋 Week 4: Turkish NLP & Production (Gün 22-28)

### **Gün 22: TR-MMLU: Turkish MMLU Benchmark**
- **arXiv ID:** `2501.00593`
- **Link:** https://arxiv.org/abs/2501.00593
- **Kategori:** Turkish NLP, Benchmark, Evaluation
- **Neden:** **SENİN ALANIN!** Turkish LLM evaluation benchmark
- **Abstract çekilecek:** ✅

---

### **Gün 23: Cetvel: Turkish LLM Benchmark**
- **arXiv ID:** `2508.16431`
- **Link:** https://arxiv.org/abs/2508.16431
- **Kategori:** Turkish NLP, Benchmark, Comprehensive Evaluation
- **Neden:** İkinci Turkish benchmark - comprehensive evaluation suite
- **Abstract çekilecek:** ✅

---

### **Gün 24: LLM Inference Serving: Survey of Recent Advances**
- **arXiv ID:** `2407.12391`
...
### **Gün 25: A Survey on Inference Engines for Large Language Models**
- **arXiv ID:** `2505.01658`
...
### **Gün 27: Phi-4-reasoning Technical Report**
- **arXiv ID:** `2504.21318`
- **Link:** https://arxiv.org/abs/2504.21318
- **Kategori:** Reasoning, Model Release, Technical Report
- **Neden:** Phi-4'ün reasoning-focused version
- **Abstract çekilecek:** ✅

---

### **Gün 28: Tulu 3: Pushing Frontiers in Open Language Model Post-Training**
- **arXiv ID:** `2411.15124`
- **Link:** https://arxiv.org/abs/2411.15124
- **Kategori:** Post-training, RLHF, Open Models
- **Neden:** Allen AI'ın post-training SOTA - fully open approach
- **Abstract çekilecek:** ✅
...
### **Gün 29: OLMo 3 Technical Report**
- **Link:** https://allenai.org/olmo (check for latest arXiv link)
- **Alternatif:** PDF dosyası zaten mevcut: `olmo_3_technical_report-1.pdf`
...
- **Abstract çekilecek:** ✅ (from uploaded PDF or search)
...
## 💪 Challenge Başarı Kriterleri

- [ ] 29/29 makale okundu
- [ ] Her makale için notlar alındı
- [ ] En az 3 makaleyi kendi projene uyguladın
- [ ] Turkish financial LLM için yeni bir şey öğrendin
- [ ] LinkedIn/Twitter'da paylaştın (opsiyonel)
